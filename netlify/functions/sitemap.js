...
const STATIC_ROUTES = [
  ...
  { url: '/study-in-germany',                   priority: '0.9', changefreq: 'monthly' },
  { url: '/blocked-account-germany',            priority: '0.85', changefreq: 'monthly' },
  { url: '/pricing',                            priority: '0.8', changefreq: 'monthly' },
  { url: '/visa-package',                       priority: '0.8', changefreq: 'monthly' },
