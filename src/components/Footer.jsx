    ...
    <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/4915236738625" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
          ...
          <div>
            ...
            <ul className="space-y-2 list-none m-0 p-0">
              {[
                { to: '/', label: 'Home' },
                { to: '/study-in-germany', label: 'Study in Germany' },
                { to: '/pricing', label: 'Admission Packages' },
                { to: '/visa-package', label: 'Visa Package' },
      ...
      <div className="border-t border-white/10 py-5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-gray-500 text-sm">© 2026 EasyWay Germany. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
