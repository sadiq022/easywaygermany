    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="page-hero !py-12 border-b border-primary/20">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center justify-center text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-white mb-2">Categories</h1>
          <p className="text-white/75 text-sm max-w-xl mx-auto">Manage product categories</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-wrap gap-1 bg-white rounded-xl shadow-card p-1 mb-8 w-fit">
          {[
            ...
            { to: '/admin/categories', label: 'Product Categories', icon: 'category', active: true },
