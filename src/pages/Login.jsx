...
export default function Login() {
  ...
  if (user) { navigate(next); return null }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-serif text-2xl font-bold text-gray-900 mt-5">Welcome Back</h2>
          <p className="text-gray-500 text-sm mt-1">Sign in to access your purchases</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              {loading ? (
                ...
                <><span className="material-icons-round text-base">login</span> Sign In</>
              )}
            </button>
          </form>
        </div>
